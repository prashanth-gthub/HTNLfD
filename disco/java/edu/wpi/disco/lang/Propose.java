...
public interface Propose {
   ...
   public static class Should extends Nested {
      ...
      public boolean interpret (Plan contributes, boolean continuation) {
         ...
         } else { // interruption or new toplevel plan
   ...
   public static class What extends Nested {
      ...
      private void setOptional (Task goal, String slot) {
         if ( goal.getType().getProperty(slot, "@optional", false) 
               && !goal.isDefinedSlot(slot) ) 
      ...
      protected StringBuffer toStringBuffer () { 
         return toStringBuffer(getSlot(), getValue());
      }
   }  
   ...
   /**
    * Propose.Achieved(Task...) - declare task to have been successfully achieved
    */
   public static class Achieved extends Nested {

      public static TaskClass CLASS;
      
      // for TaskClass.newStep
      public Achieved (Disco disco, Decomposition decomp, String step, boolean repeat) { 
         super(Achieved.class, disco, decomp, step, repeat);
      }

      public Achieved (Disco disco, Boolean external, Task goal) { 
         super(Achieved.class, disco, external, goal);
      }

      @Override
      protected void respond (Plan contributes, boolean implicit, boolean achieved) {
         getNested(contributes).setAchieved(achieved);
      }
      ...
      public String formatTask () {
         ...
         appendKeySp(buffer, "is@word");
         appendKey(buffer, "done@word");
         return buffer.toString();
      }
   }  
   ...
   public static class How extends Nested {
      ...
      public String toString () {
         ...
         DecompositionClass decomp = getDecomp();
         if ( !Disco.VERBOSE && decomp != null ) 
            buffer.append(',').append(decomp);
         buffer.append(')');
         return buffer.toString();
      }
