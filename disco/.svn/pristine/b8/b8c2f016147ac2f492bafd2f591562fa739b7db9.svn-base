...
public abstract class Ask extends Propose.Should {
    ...
    * Ask.Global
    */
   protected static class Global extends Ask {
    ...
    */
   protected abstract static class Nested extends Ask {
      ...
      public String toString () {
         ...
         if ( !Disco.VERBOSE && goal != null ) buffer.append(')');
      ...
      protected StringBuffer toStringBuffer (String slot, Object value) {
         StringBuffer buffer = new StringBuffer(
               Disco.VERBOSE ? toStringVerbose() : getType().toString());
         if ( !Disco.VERBOSE ) {
         	Task goal = getNestedGoal();
         	if ( goal != null ) buffer.append('(').append(goal.toString()); // recursive       
   ...
   public static class Should extends Ask.Nested {
      ...
      @Override
      public String toString() {
         // sic not super.toString()
         StringBuffer buffer = new StringBuffer(getType().toString()); 
         Task goal = getNestedGoal();
         if ( goal != null ) buffer.append('(').append(goal).append(')');
         return buffer.toString();
      }
   ...
   public static class What extends Ask.Nested {      
      ...
      protected StringBuffer toStringBuffer () { 
         return toStringBuffer(getSlot(), null);
      }
   }
