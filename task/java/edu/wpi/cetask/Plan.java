...
public class Plan {
   ...
   public boolean isDone () {
      return ( occurred() || isSuccess() || isComplete() ) && !isFailed();
   }
   ...
   // used for checking fortuitous success in TaskEngine
   // note must be live or executed to apply
   boolean isAchievedSufficient () {
      return isSuccess() ||
   ...
   */
   ...
   /**
    * Test whether this plan has any remaining steps that could be executed.
   ...
   private boolean isMooted () {
      return parent != null && 
        ( parent.occurred() || parent.isSuccess() || parent.isMooted());
   }
